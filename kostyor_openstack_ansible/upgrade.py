...
def _run_playbook(playbook, hosts_fn=None, ignore_errors=False):
...
@app.task
def run_playbook(playbook, ignore_errors=False):
    return _run_playbook(playbook, ignore_errors=ignore_errors)


@app.task
def run_playbook_for(playbook, host, service, ignore_errors=False):
